 ...
 */
unsigned int sysctl_sched_latency			= 3000000ULL; /* KernelBumi 4GB: 3ms */
...
const_debug unsigned int sysctl_sched_migration_cost	= 250000UL; /* KernelBumi: 250us */
...
void post_init_entity_util_avg(struct sched_entity *se)
{
	...
	long cap = (long)(cpu_scale - cfs_rq->avg.util_avg) * 3 / 4; /* KernelBumi: 75% init util */
